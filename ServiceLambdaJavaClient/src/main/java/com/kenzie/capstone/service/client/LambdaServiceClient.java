...
public class LambdaServiceClient {
    ...
    private static final String WELCOME_EMAIL_ENDPOINT = "user/email/reminder";
    ...
    public void sendWelcomeEmail(String data){
        System.out.println("Lambda Service Client");
        EndpointUtility endpointUtility = new EndpointUtility();
        String response = endpointUtility.postEndpoint(WELCOME_EMAIL_ENDPOINT, data);
    }
}
